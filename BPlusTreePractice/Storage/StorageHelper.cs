...
namespace BPlusTreePractice
{
  ...
  internal static class StorageHelper
  {
    ...
    {
      int limit = StorageConstants.IntegerLength;

      if (atIndex + limit > toArray.Length)
      {
        throw new BPlusTreeException("Cannot access beyond end of array.");
      }
    ...
    {
      int limit = StorageConstants.LongLength;
    ...
    {
      int limit = StorageConstants.ShortLength;

      int theInt = value;
      if (atIndex + limit > toArray.Length)
      {
        throw new BlockFileException("Cannot access beyond end of array.");
      }
